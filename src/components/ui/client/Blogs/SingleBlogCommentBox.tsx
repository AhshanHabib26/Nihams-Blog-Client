    ...
    <div className="text-gray-600">
      {token ? (
        <div>
          <form onSubmit={createCommentHandler}>
            ...
            <div className="flex items-end justify-end">
              <Button
                type="submit"
                className="h-[45px] rounded text-lg hind-siliguri-light mt-2 bg-myBgPrimary hover:bg-myBgSecondary"
              >
                Send message
              </Button>
            </div>
        ...
        <div className="flex items-center justify-center my-5">
          <Link to="/login">
            <Button className="bg-myBgPrimary hover:bg-myBgSecondary text-lg h-[50px] hind-siliguri-light">
